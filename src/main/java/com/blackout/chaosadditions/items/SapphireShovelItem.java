...
public class SapphireShovelItem extends ShovelItem implements ICATieredItem {
	...
	public SapphireShovelItem(CADEnumUtils.CADItemTier pTier, Supplier<ForgeConfigSpec.IntValue> configDmg, float pAttackSpeedModifier, Item.Properties properties) {
