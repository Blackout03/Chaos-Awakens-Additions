...
public class SapphirePickaxeItem extends PickaxeItem implements ICATieredItem {
	...
	public SapphirePickaxeItem(CADEnumUtils.CADItemTier pTier, Supplier<ForgeConfigSpec.IntValue> configDmg, float pAttackSpeedModifier, Item.Properties properties) {
