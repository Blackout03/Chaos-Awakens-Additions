...
public class SapphireAxeItem extends AxeItem implements ICATieredItem {
	...
	public SapphireAxeItem(CADEnumUtils.CADItemTier pTier, Supplier<ForgeConfigSpec.IntValue> configDmg, float pAttackSpeedModifier, Item.Properties properties) {
